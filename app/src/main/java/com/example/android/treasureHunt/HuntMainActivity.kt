 ...
 */
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_TURN_DEVICE_LOCATION_ON) checkDeviceLocationSettingsAndStartGeofence(
            false
        )
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (
            grantResults.isEmpty() or
            (grantResults[LOCATION_PERMISSION_INDEX] == PackageManager.PERMISSION_DENIED) or
            (requestCode == REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE) and (grantResults[BACKGROUND_LOCATION_PERMISSION_INDEX] == PackageManager.PERMISSION_DENIED)
        ) {
            // Permission denied.
            Snackbar.make(
    ...
    private fun addGeofenceForClue() {
        ...
        geofencingClient.removeGeofences(geofencePendingIntent).run {
            addOnCompleteListener {
                ...
                ) Log.e(TAG, "Fine location permission fail.")
